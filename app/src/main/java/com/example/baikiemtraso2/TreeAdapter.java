...
//        });
        ...
        holder.imgEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText Science_name = view.findViewById(R.id.txtName_Science);
                EditText name = view.findViewById(R.id.txtCommon_Name);
                EditText Characteristic = view.findViewById(R.id.txtCharacteristic);
                EditText leaf_color = view.findViewById(R.id.txtLeaf_color);
                EditText url = view.findViewById(R.id.txtImageUrl);

                Button btnUpdate = view.findViewById(R.id.btnUpdate);

                Science_name.setText(model.getName());
                name.setText(model.getName());
                Characteristic.setText(model.getName());
                leaf_color.setText(model.getName());
    ...
    class myViewHolder  extends RecyclerView.ViewHolder {
        TextView Science_name, name,Characteristic,leaf_color ;
        ...
        public myViewHolder(@NonNull View itemView) {
            ...
            Science_name=(TextView) itemView.findViewById(R.id.txtName_Science);
            name = (TextView) itemView.findViewById(R.id.txtName_Science);
            Characteristic = (TextView) itemView.findViewById(R.id.txtCharacteristic);
            leaf_color = (TextView) itemView.findViewById(R.id.txtLeaf_color);
